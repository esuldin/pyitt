...
class EventTests(TestCase):
    ...
    def test_event_representation_for_non_event_object(self):
        ...
        self.assertEqual(str(context.exception), f"descriptor '__repr__' requires a 'pyitt.native.{Event.__name__}'"
    ...
    def test_event_string_representation_for_non_event_object(self):
        ...
        self.assertEqual(str(context.exception), f"descriptor '__str__' requires a 'pyitt.native.{Event.__name__}'"
                                                 f" object but received a 'NoneType'")
